            ...
            <div class="hero__slider swiper-container">
                ...
                <div class="swiper-wrapper">
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" style="background-image: url(<?php echo get_theme_file_uri('images/thumbs/featured/featured-01_2000.jpg'); ?>);"></div>
                    ...
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" style="background-image: url(<?php echo get_theme_file_uri('images/thumbs/featured/featured-02_2000.jpg'); ?>);"></div>
                        <div class="hero__entry-text">
                            <div class="hero__entry-text-inner">
                                <div class="hero__entry-meta">
                                    <span class="cat-links">
                    ...
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" style="background-image: url(<?php echo get_theme_file_uri('images/thumbs/featured/featured-03_2000.jpg'); ?>);"></div>
                        <div class="hero__entry-text">
                            <div class="hero__entry-text-inner">
                                <div class="hero__entry-meta">
                                    <span class="cat-links">
                        ...
                        <article class="brick entry" data-animate-el>
                            ...
                            <div class="entry__thumb">
                                <a href="single-standard.html" class="thumb-link">
                                    <img src="<?php echo get_theme_file_uri('images/thumbs/featured/featured-01_2000.jpg'); ?>" 
                                        srcset="<?php echo esc_url(site_url('/images/thumbs/masonry/statue-600.jpg 1x, images/thumbs/masonry/statue-1200.jpg 2x')); ?>" alt="">
                                </a>
